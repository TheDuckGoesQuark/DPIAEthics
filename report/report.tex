...
As a technology, it has matured enough to be considered fairly accurate. 
...
The difficulty of these evaluations have also increased over time.
...
Ensuring that usage of the technology satisfies privacy concerns is mostly the responsibility of those using the service, as this project does not share any data provided by its users.

\paragraph{Are you signed up to any approved code of conduct or certification scheme (once any have been approved)}
% TODO ??
