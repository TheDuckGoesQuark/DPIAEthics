...
\multicolumn{1}{|p{\linewidth}|}{
    ...
    Consumers of the cognitive services API provide all data used by the software, which includes images of people for identification and training. 
    None of the images submitted are retained in their raw form. 
    Instead, images are deconstructed on submission into face landmarks (coordinates of facial features) and attributes (age, emotion, gender, etc.) \cite{patrickfarley}. 
    Users are also able to attach custom metadata to any group or person that they create using the API. 
    ...
    The models and data can only be accessed and manipulated by those with %TODO who has access \cite{terrylanfear}
